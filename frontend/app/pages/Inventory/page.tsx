...
export default function TablePage() {
    ...
    const toggleDetailModal = (medicine: Medicine | null = null) => {
                    ...
                    <div className="text-left w-full">
                      ...
                      <div className="mt-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Category (Tablet, Syrup,etc.)</label>
                            <input
                              type="text"
                              className="mt-1 block w-full pl-3 pr-10 py-2 border-2 border-gray-300 rounded-md sm:text-sm"
                            />
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Status (In Stock/Out of Stock)</label>
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Temperature Requirements</label>
                            <input
                              type="text"
                              className="mt-1 block w-full pl-3 pr-10 py-2 border-2 border-gray-300 rounded-md sm:text-sm"
                            />
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Certification/Patents</label>
                            <input
                              type="text"
                              className="mt-1 block w-full pl-3 pr-10 py-2 border-2 border-gray-300 rounded-md sm:text-sm"
                            />
        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 text-left">Manufactured Date</th>
              <th className="px-4 py-2 text-left">Quantity In Stock</th>
              <th className="px-4 py-2 text-left">Category</th>
              <th className="px-4 py-2 text-left">Reorder Level</th>
              <th className="px-4 py-2 text-left">Reorder Quantity</th>
              <th className="px-4 py-2 text-left">Status</th>
              <th className="px-4 py-2 text-left">Minimum Stock Level</th>
              <th className="px-4 py-2 text-left">Maximum Stock Level</th>
              <th className="px-4 py-2 text-left">Storage Location</th>
              <th className="px-4 py-2 text-left">Temperature Requirements</th>
              <th className="px-4 py-2 text-left">Certification/Patents</th>
            </tr>
          </thead>
          <tbody>
                      {tableData.map((item, index) => (
                        <tr key={index} className="hover:bg-gray-100"   onClick={() => toggleDetailModal(item)}>
                          ...
                          <td className="px-4 py-2 text-left">{item.certification}</td>
                        </tr>
                      ))}
                    </tbody>
        </table>
