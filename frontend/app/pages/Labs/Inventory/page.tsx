...
import Addnew from "@/components/Labs/Addnew";
import MedicineDetails from "@/components/Labs/MedicineDetails";
      ...
      >
        <div className="relative flex-1 py-6 px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-4">
            ...
            <FilterComponent options={Hospitals} label="Hospital" />
          </div>
        </div>
          ...
          {tableMainData &&
            tableMainData.map((item: Medicine, index: any) => (
              ...
              >
                ...
                <td className=" text-center">{item.hospital}</td>
              </tr>
            ))}
        </tbody>
      </table>
