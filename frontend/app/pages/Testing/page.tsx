...
export default function TablePage() {
    ...
    const [selectedMedicine, setSelectedMedicine] = useState<Testing | null>(null);
    ...
    const toggleDetailModal = (orders: Testing | null = null) => {
                    ...
                    <div className="text-left w-full">
                      ...
                      <div className="mt-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Testing Lab</label>
                            <input
                              type="text"
                              className="mt-1 block w-full pl-3 pr-10 py-2 border-2 border-gray-300 rounded-md sm:text-sm"
                            />
                          ...
                          <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Standard Compliance</label>
                            <input
                              type="date"
                              className="mt-1 block w-full pl-3 pr-10 py-2 border-2 border-gray-300 rounded-md sm:text-sm"
                            />
          ...
          <Dialog.Panel className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll rounded-l-md">
            ...
            <div className="relative flex-1 py-6 px-4 sm:px-6">
              <div className="grid grid-cols-1 gap-4">
                <FilterComponent options={ItemId} label="Test Id" />
                <FilterComponent options={ItemName} label="Item Id" />
                <FilterComponent options={BatchNumber} label="Test Type" />
                <FilterComponent options={Manufacturer} label="Lab" />
                <FilterComponent options={expiryOptions} label="Test Results" />
        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 text-left">Testing Lab</th>
              <th className="px-4 py-2 text-left">Standard Compliance(FDA, WHO, EMA, CD)</th>
              <th className="px-4 py-2 text-left">Test Result(pass/fail)</th>
              <th className="px-4 py-2 text-left">Test Report</th>
              <th className="px-4 py-2 text-left">Technician Name</th>
              <th className="px-4 py-2 text-left">Test Status</th>
              <th className="px-4 py-2 text-left">Remarks</th>
              <th className="px-4 py-2 text-left">Next Test Date</th>
            </tr>
          </thead>
          <tbody>
